...
ActiveRecord::Schema.define(version: 20180215140516) do
  ...
  add_index "countries_target_groups", ["country_id", "target_group_id"], name: "idx_country_id_target_group_id", using: :btree
  add_index "countries_target_groups", ["target_group_id", "country_id"], name: "idx_target_group_id_country_id", using: :btree
  ...
  add_index "location_groups_locations", ["location_group_id", "location_id"], name: "idx_location_group_id_location_id", using: :btree
  add_index "location_groups_locations", ["location_id", "location_group_id"], name: "idx_location_id_location_group_id", using: :btree
